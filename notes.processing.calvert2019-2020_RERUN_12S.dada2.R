#processing and analysis for 12S calvert 2019-2020 RERUN samples
#author: Evan Morien
#last modified: Sept 13th, 2021
...
####Environment Setup####
theme_set(theme_bw())
setwd("~/projects/12S_runs/calvert_12S/calvert2019_2020_RE-RUN_20210827/")

####File Path Setup####
#this is so dada2 can quickly iterate through all the R1 and R2 files in your read set
path <- "~/projects/12S_runs/calvert_12S/calvert2019_2020_RE-RUN_20210827/raw_data/" # CHANGE ME to the directory containing the fastq files
list.files(path)
...
####assign taxonomy with blast using ncbi NT db####
mkdir blast_96_sim
...
####assign taxonomy using RDP classifier and MitoFish db ####
