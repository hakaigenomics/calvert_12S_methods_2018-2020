#processing and analysis for 12S calvert 2019-2020 samples
#author: Evan Morien
#last modified: Aug 26th, 2021
...
####Environment Setup####
theme_set(theme_bw())
setwd("~/projects/12S_runs/calvert_12S/calvert2019_2020_Run20210809/")

####File Path Setup####
#this is so dada2 can quickly iterate through all the R1 and R2 files in your read set
path <- "~/projects/12S_runs/calvert_12S/calvert2019_2020_Run20210809/raw_data/" # CHANGE ME to the directory containing the fastq files
list.files(path)
